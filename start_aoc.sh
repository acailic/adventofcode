...
# start_aoc.sh
# Script to download input data and create templates for Advent of Code
...
input_only=0
silent=0
CURL_AGENT="-A \"github.com/acailic/adventofcode/start_aoc.sh\""

declare -a languages=("python" "C" "java")
